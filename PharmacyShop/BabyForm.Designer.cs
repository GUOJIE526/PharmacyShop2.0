namespace PharmacyShop
{
    partial class BabyForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            // pnlbaby
            // 
            this.pnlbaby.Controls.Add(this.lblSumPrice);
            this.pnlbaby.Controls.Add(this.btnAddCart);
            this.pnlbaby.Controls.Add(this.btnMinus);
            this.pnlbaby.Controls.Add(this.btnAdd);
            this.pnlbaby.Controls.Add(this.txtqty);
            this.pnlbaby.Controls.Add(this.txtProd);
            this.pnlbaby.Controls.Add(this.panel2);
            this.pnlbaby.Controls.Add(this.label1);
            this.pnlbaby.Controls.Add(this.tabBaby);
            this.pnlbaby.Controls.Add(this.btnReturn);
            ...
            this.dataDiaper.ThemeStyle.RowsStyle.Height = 24;
